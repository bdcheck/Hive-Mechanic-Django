...
define(modules, function (mdc, Node) {
    class ProcessGuessNode extends Node {
...
//                }
            ...
            body += '  Processes guess to prior message and proceeds to the first action to match response.';
            body += '</div>';
    ...
    Node.registerCard('process-guess', ProcessResponseNode);
});
